...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/CpmtBTotpqE?controls=0&amp;start=65" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Godzilla, Méga terre, difficile de faire plus cool comme surnom. Cette exoplanète est pour beaucoup de scientifiques semblable à la Terre. Ce qui la rend assez rare dans un univers infini.
        </div>
        <div class="caracteristique">
            Distance de la Terre : 564,3 années-lumière/Rayon : 14 972 km
        </div>
        <div class="prix">
            Prix :  4999 Billion $
        </div>
