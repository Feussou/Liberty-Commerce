...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Nt1Ejt8GroM?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Triton : Colosse des 14 Satellites naturels de Neptune, Triton est la « septième lune » de Neptune. Astroneom vous propose une réduction à l’achat si vous êtes déjà propriétaire de Neptune !
        </div>
        <div class="caracteristique">
            Rayon : 1 353,4 km/Distance de la Terre : 4,338 milliards km/Orbite : Neptune
        </div>
        <div class="prix">
            Prix :  2999 Billion $
        </div>
