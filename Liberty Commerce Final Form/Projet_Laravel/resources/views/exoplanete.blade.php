...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ute6IYb7uXA?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Exoplanète : Exo à été renommée par l’équipe marketing d’Astroneom. D’une extrême rareté et peu d’informations, comme toutes les exoplanète
        </div>
        <div class="caracteristique">
            Non connu/Etude réalisable sous condition de commande
        </div>
        <div class="prix">
            Prix : 2000 Billion $
        </div>
