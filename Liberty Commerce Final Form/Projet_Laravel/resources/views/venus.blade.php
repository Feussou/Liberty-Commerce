...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ZfgG7bher2M?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Vénus : Féru de mythologie grecque ? Vénus est la plus chaude ! Deuxième planète à partir du Soleil, Vénus profite d’un rayonnement deux fois supérieur à celui de la Terre, Pensez à prendre votre crème solaire ! Pour un prix attractif, la déesse de l’amour peut être à vous, alors n’hésitez plus !
        </div>
        <div class="caracteristique">
            Superficie = 460,2 millions km²/Rayon = 6 051,8 km
        </div>
        <div class="prix">
            Prix :  1989 Billion $
        </div>
