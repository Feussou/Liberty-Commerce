...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/jB6tRlpxV4A?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Neptune : 17 fois la masse de la Terre, et 4 fois son diamètre, elle est aussi la deuxième planète la plus eloignée du Soleil au sein de notre système solaire.
        </div>
        <div class="caracteristique">
            Superficie = 7,618 milliards km²/Rayon = 24 622 km
        </div>
        <div class="prix">
            Prix :  4500 Billion $
        </div>
