...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/6H1zlgbv-Lo?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            gj-504 : Loin des yeux près du coeur. Exclusivement chez Astroneom, « la planète rose » vous tend les bras. 4 fois plus massive que Jupiter, et âgée de seulement 160 millions d'années, c’est une planète quasi-neuve.
        </div>
        <div class="caracteristique">
            Rayon : 68 632 km/Distance de la Terre : 57 années-lumière.
        </div>
        <div class="prix">
            Prix :  4300 Billion $
        </div>
