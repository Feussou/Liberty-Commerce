...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/K5PaYF7mZ7o?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Exo : Est-t-elle en feu ? Est-ce un dragon qui fait le tour de la planète ? Tant de mystères entourent les exoplanètes… Peut être que ce sera à vous de les révéler ! 
        </div>
        <div class="caracteristique">
            Rayon : 34 376 km/Distance de la Terre : 32 années-lumière
        </div>
        <div class="prix">
            Prix :  3200 Billion $
        </div>
