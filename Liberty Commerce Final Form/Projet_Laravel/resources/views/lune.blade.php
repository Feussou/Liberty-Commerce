...
<header role="header">
    ...
    <div class="produit">
        <div class="video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/DfOZuuScPRE?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="description">
            Lune : Une fois lancé dans l’achat de planète, on a l’impression de ne jamais en avoir assez. Et quoi de mieux qu’un beau Satellite naturel pour compléter votre collection ?
        </div>
        <div class="caracteristique">
            Rayon = 1 737,4 km/Superficie = 21,3 millions de km²
        </div>
        <div class="prix">
            Prix : 2450 Billion $
        </div>
